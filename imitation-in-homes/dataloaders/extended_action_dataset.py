...
class ExtendedActionDataset(DecordDataset):
    ...
    def __getitem__(self, index) -> Tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
        ...
        if self._data_config.use_object_pos:
            object_pos = self._get_object_pos(trajectory_slice)
            return frames, object_pos, is_padding, actions
    ...
    def _convert_subslice_to_action_indices(
        ...
        subseq_indices = self._get_filtered_frame_indices(subslice.trajectory_index)[subseq_indices]
